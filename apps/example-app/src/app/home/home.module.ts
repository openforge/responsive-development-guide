...
@NgModule({
    imports: [CommonModule, FormsModule, IonicModule, HomePageRoutingModule, DevicesPopoverModule, SimulationDeviceContentModule, DefaultPhoneLayoutModule, IphoneLayoutModule],
